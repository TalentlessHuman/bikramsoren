document.addEventListener('DOMContentLoaded', function() {
    ...
    const workExperience = [
        ...
        { title: "Convenor", company: "Infinition (Math Club of KGEC)", date: "July 2025 - June 2026", description: "Leading the mathematics club of Kalyani Government Engineering College as the Convenor. Responsible for planning and executing all club activities, workshops, and events." },
